/*!
{
  ...
  "date": "2019-07-16T22:03:33.135Z",
  "describe": "",
  "description": "A big counter.",
  "file": "big-counter-x.js",
  "hash": "fc920b9b19637cff1623",
  "license": "MIT",
  "version": "4.0.1"
}
*/
...
if (nativeReduceR) {
  array_reduce_right_x_esm_isWorking = attempt.call([], nativeReduceR, function (acc) {
  ...
  if (array_reduce_right_x_esm_isWorking) {
    array_reduce_right_x_esm_res = attempt.call(array_reduce_right_x_esm_castObject('abc'), nativeReduceR, function (acc, c) {
      array_reduce_right_x_esm_newArrowCheck(this, array_reduce_right_x_esm_this);
  ...
  if (array_reduce_right_x_esm_isWorking) {
    array_reduce_right_x_esm_res = attempt.call(function getArgs() {
      /* eslint-disable-next-line prefer-rest-params */
      return arguments;
  ...
  if (array_reduce_right_x_esm_isWorking) {
    array_reduce_right_x_esm_res = attempt.call({
      0: 1,
      1: 2,
      3: 3,
      4: 4,
  ...
  if (array_reduce_right_x_esm_isWorking) {
    ...
    if (array_reduce_right_x_esm_doc) {
      ...
      array_reduce_right_x_esm_res = attempt.call(array_reduce_right_x_esm_fragment.childNodes, nativeReduceR, function (acc, node) {
        array_reduce_right_x_esm_newArrowCheck(this, array_reduce_right_x_esm_this);
  ...
  if (array_reduce_right_x_esm_isWorking) {
    array_reduce_right_x_esm_res = attempt.call('ab', nativeReduceR, function (_, __, ___, list) {
      array_reduce_right_x_esm_newArrowCheck(this, array_reduce_right_x_esm_this);
